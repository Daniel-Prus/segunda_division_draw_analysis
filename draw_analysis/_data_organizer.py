...
class _DataOrganizer:
    ...
    graph_colors = ['tab:red', 'tab:orange', 'tab:blue']

    text_font = {'fontname': 'Arial', 'size': '12', 'color': 'black', 'weight': 'normal',
                 'verticalalignment': 'bottom'}

    explode_tuple = (0.03, 0.01, 0.01)
    ...
    def __init__(self, rawdata):
        ...
        _DataOrganizer.__matplotlib_params_setter(_DataOrganizer.style, _DataOrganizer.params)
        _DataOrganizer.data_info(self)
    ...
    def data_info(self):
        ...
        print(f"\tCountry: {self._fixtures_data.league_country[0]} \n",
              f"\tLeague name: {self._fixtures_data.league_name[0]} \n",
              f"\tLeague id: {self._fixtures_data.league_id[0]} \n",
    ...
    def league_table(self, season):
        ...
        columns_to_add = ['MP', 'W', 'D', 'L', 'GF', 'GA', 'Pts']
        league_table = home_table[columns_to_add].add(away_table[columns_to_add])
        league_table.insert(6, column='GD', value=league_table['GF'] - league_table['GA'])
...
def transfrom_rawdata_api_fixtures(rawdata, nan):
    ...
    columns_to_category_type = ['league_name', 'league_country', 'league_round', 'teams_home_name',
